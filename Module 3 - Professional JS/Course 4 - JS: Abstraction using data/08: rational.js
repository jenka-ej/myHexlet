...
// 1) Конструктор makeRational() - принимает на вход числитель и знаменатель, возвращает дробь в виде объекта
// 2) Селектор getNumer() - возвращает числитель
// 3) Селектор getDenom() - возвращает знаменатель
// 4) Сложение add() - складывает переданные дроби
// 5) Вычитание sub() - находит разность между двумя дробями
